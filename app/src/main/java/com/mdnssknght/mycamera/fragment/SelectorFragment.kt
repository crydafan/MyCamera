...
class SelectorFragment : Fragment() {
    ...
    companion object {
        ...
        /** Helper class used as data holder for each selectable camera format item. */
        ...
        private fun enumerateCameras(cameraManager: CameraManager): List<FormatItem> {
            ...
            cameraIds.forEach { id ->
                ...
                // Return cameras that support RAW capabilities.
                ...
                // Return cameras that support JPEG DEPTH capabilities.
